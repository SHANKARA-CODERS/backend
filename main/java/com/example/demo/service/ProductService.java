...
//	}
	...
	public ResponseEntity<List<Product>> getProductByUsername(String username) {
		return new ResponseEntity<List<Product>>(productRepo.findByShopProducts_Shop_Username(username), HttpStatus.OK);
	}
